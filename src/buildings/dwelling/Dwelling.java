...
public class Dwelling implements Building, Serializable
{
    ...
    public Dwelling(Floor... newFloors)
    {
        ...
        for (int i = 0; i < floors.length; ++i)
        {
            ...
            floors[i] = (Floor)newFloors[i].clone();
        }
    }
    ...
    public Floor[] getFloors()
    {
        ...
        for (int i = 0; i < floors.length; ++i)
        {
            ...
            forReturn[i] = (Floor)floors[i].clone();
        }
        return forReturn;
    }
    ...
    public Floor getFloor(int floorNumber) throws FloorIndexOutOfBoundsException
    {
        ...
        return (Floor)floors[floorNumber].clone();
    }
    ...
    public void setFloor(int floorNumber, Floor newFloor) throws FloorIndexOutOfBoundsException
    {
        ...
        floors[floorNumber] = (Floor)newFloor.clone();
    }

    public Space getSpace(int flatNumber) throws SpaceIndexOutOfBoundsException
    {
...
//                        floors[floorNumber].getSpace(flatNumber).getRoomsAmount());
        return (Space)floors[floorNumber].getSpace(flatNumber).clone();
    }
